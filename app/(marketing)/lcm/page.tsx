...
export default function LCMPage() {
    return (
        <div className="bg-page-bg text-midnight">
            <div className="mx-auto max-w-6xl px-4 pb-10 pt-10 md:pb-14 md:pt-14">
                <div className="space-y-10 md:space-y-12">
                    <RevealOnScroll>
                        <section className="hero-pattern rounded-3xl bg-white/90 px-8 py-14 shadow-sm ring-1 ring-midnight/5 md:px-16 md:py-20">
                            <div className="space-y-6">
                                ...
                                <div className="max-w-2xl space-y-4 text-sm leading-relaxed text-midnight/80">
                                    <p>
                                        VeraLearning&apos;s Learning Context Model (LCM) encodes the
                                        competencies, expectations, and standards an organization
                                        already uses and provides the shared context an AI system
                                        needs to apply them consistently across learners,
                                        interactions, and time.
                                    </p>
                                    <p>
                                        LCM provides a persistent structure that guides how AI
                                        conducts learning interactions, interprets learner behavior,
                                        and accumulates evidence in alignment with established skill
                                        maps and competency definitions.
                                    </p>
                                    <p>
                                        This allows VeraCredentials to produce assessments that are
                                        consistent, transparent, and defensible within real
                                        organizational and regulatory contexts.
                                    </p>
                                </div>

                                <div className="mt-8 max-w-2xl space-y-4 border-l-2 border-midnight/10 pl-4">
                                    <p className="text-sm font-medium text-midnight/80">
                                        LCM provides a stable learning context by explicitly
                                        modeling:
                                    </p>
                                    ...
                                    <p className="text-sm leading-relaxed text-midnight/80">
                                        This enables assessments that are consistent across
                                        learners, explainable to stakeholders, and defensible in
